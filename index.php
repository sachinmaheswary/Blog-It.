...
<div  class="bg-image" >
    ...
    <div class="container m-auto mt-3 row">
       ...
       if(isset($_GET['search'])){
         $keyword = $_GET['search'];
         $postQuery="SELECT * FROM posts WHERE title LIKE '%$keyword%' ORDER BY id ASC LIMIT $result,$post_per_page";
       }else{
        $postQuery="SELECT * FROM posts ORDER BY id ASC LIMIT $result,$post_per_page";
       }
